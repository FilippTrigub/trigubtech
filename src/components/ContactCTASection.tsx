  ...
  return (
    <div className="bg-primary py-20 px-4 text-center">
      ...
      <motion.p
        ...
        className={`text-xl md:text-2xl text-text-light mb-8 max-w-2xl mx-auto ${FONT_CONFIG.BODY_FONT}`}
      >
      ...
      >
        <Link
          to="/contact"
          className={`text-xl md:text-2xl bg-secondary text-text-dark font-bold py-3 px-8 rounded-full hover:bg-opacity-90 transition-colors duration-300 ${FONT_CONFIG.BODY_FONT}`}
        >
          Get in Touch
        </Link>
      </motion.div>
