...
const Header: React.FC<HeaderProps> = ({ currentPage }) => {
  ...
  return (
    <>
      <header className="bg-text-dark shadow-lg relative z-50">
        <div className="flex items-center justify-between px-4 h-20">
          {/* Menu Button */}
          <button
            onClick={toggleMenu}
            className="text-text-light hover:text-secondary transition-colors duration-200 p-2"
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 h-full w-80 bg-text-dark shadow-2xl z-50 flex flex-col"
            >
              {/* Header */}
